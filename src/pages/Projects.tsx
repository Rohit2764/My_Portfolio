  ...
  const projects = [
    {
      ...
      description: "A mobile application that helps users track their carbon footprint and suggests eco-friendly alternatives for daily activities.",
      longDescription: "EcoTrack is a comprehensive sustainability platform that empowers users to make environmentally conscious decisions. The app features real-time carbon footprint tracking, personalized recommendations, and a community platform for sharing green initiatives.",
